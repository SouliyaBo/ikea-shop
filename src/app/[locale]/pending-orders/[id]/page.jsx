				...
				{loading ? (
					...
					<div className="flex flex-col items-center justify-center h-[50vh] gap-3">
						...
						<div className="text-center">
							<h3 className="mb-1 text-base font-semibold text-gray-900">ไม่มีคำสั่งซื้อรอดำเนินการ</h3>
							<p className="text-sm text-gray-500">คำสั่งซื้อจะแสดงที่นี่เมื่อมีการสั่งซื้อ</p>
						</div>
					</div>
				) : (
				...
				<DialogContent className="sm:max-w-[425px]">
					...
					<DialogFooter>
						...
						<Button
							...
							disabled={isSubmitting}
						>
							{isSubmitting ? "กำลังดำเนินการ..." : t("confirmText")}
						</Button>
					</DialogFooter>
				</DialogContent>
			</Dialog>
